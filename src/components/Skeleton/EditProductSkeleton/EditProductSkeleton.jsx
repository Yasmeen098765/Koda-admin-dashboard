...
const EditProductSkeleton = ({ baseColor, highlightColor }) => {
  return (
    <SkeletonTheme baseColor={baseColor} highlightColor={highlightColor}>
      <main className="min-h-screen overflow-x-hidden p-3 sm:p-4 md:p-6 lg:p-8 space-y-4 sm:space-y-5 md:space-y-6 lg:space-y-8 bg-slate-50/50 text-slate-900 mx-auto max-w-[1600px] dark:bg-slate-900">
        <div className="relative overflow-hidden rounded-xl border border-slate-200/50 dark:border-slate-700/50 bg-gradient-to-br from-white via-sky-50/80 to-blue-100/40 dark:from-slate-800 dark:via-slate-800/90 dark:to-sky-900/30 p-4 sm:p-5 md:p-6 lg:p-8 shadow-lg transition-all hover:shadow-xl">
          ...
          <div className="relative z-10 flex flex-col gap-4 sm:gap-5 md:gap-6 lg:flex-row lg:items-end lg:justify-between">
            <div className="w-full">
              ...
              <Skeleton width={300} height={16} className="mt-2 sm:mt-3" />
            </div>
        ...
        <div className="grid grid-cols-1 gap-4 sm:gap-5 md:gap-6 lg:gap-8 xl:grid-cols-[0.95fr_1.05fr]">
          <section className="rounded-xl border border-slate-200/50 dark:border-slate-700/50 bg-gradient-to-br from-white via-sky-50/80 to-blue-100/40 dark:from-slate-800 dark:via-slate-800/90 dark:to-sky-900/30 p-4 sm:p-5 md:p-6 shadow-lg transition-all hover:shadow-xl">
            <div className="flex items-center gap-3 sm:gap-4">
              <Skeleton
                width={44}
                height={44}
            ...
            <div className="mt-4 sm:mt-5 md:mt-6 grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
              {[1, 2].map((item) => (
                <div
                  key={item}
                  className="rounded-xl border border-slate-200/50 dark:border-slate-700/50 overflow-hidden aspect-square"
                >
            ...
            <div className="mt-4 sm:mt-5 md:mt-6 rounded-xl border-2 border-dashed border-cyan-500/30 dark:border-cyan-500/20 bg-cyan-50/50 dark:bg-slate-800/30 p-6 sm:p-8 md:p-10">
          ...
          <section className="rounded-xl border border-slate-200/50 dark:border-slate-700/50 bg-gradient-to-br from-white via-sky-50/80 to-blue-100/40 dark:from-slate-800 dark:via-slate-800/90 dark:to-sky-900/30 p-4 sm:p-5 md:p-6 shadow-lg transition-all hover:shadow-xl">
            <div className="grid gap-4 sm:gap-5 md:gap-6">
              ...
              <div className="rounded-xl border border-slate-200/50 dark:border-slate-700/50 bg-white/70 dark:bg-slate-800/50 p-4 sm:p-5 md:p-6">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-start gap-2 sm:gap-3 border-t border-slate-200/50 dark:border-slate-700/50 pt-4 sm:pt-5 md:pt-6 mt-1 sm:mt-2">
